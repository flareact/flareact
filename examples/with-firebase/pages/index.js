...
export default function Home() {
  ...
  return (
    <div className="container">
      <Head>
        <title>Flareact w/ Firebase Client-Side</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <main>
        <h1 className="title">Flareact.js w/ Firebase Client-Side</h1>
        ...
        <button onClick={createUser}>Create 'Flareact_user'</button>
